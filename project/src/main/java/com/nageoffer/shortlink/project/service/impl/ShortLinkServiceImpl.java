...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    public ShortLinkCreateRespDTO createShortLink(ShortLinkCreateReqDTO requestParam) {
        ...
        try {
            ...
            ShortLinkDO hsaShortLinkDO = baseMapper.selectOne(queryWrapper);
            if (hsaShortLinkDO != null){
                String message = "短链接: " + fullShortUrl + " 重复入库";
                log.warn(message);
    ...
    public List<ShortLinkGroupCountQueryRespDTO> listGroupShortLinkCount(List<String> requestParam) {
        QueryWrapper<ShortLinkDO> queryWrapper = Wrappers.query(new ShortLinkDO())
                .select("gid as gid, count(*) as shotLinkCount")
                .in("gid", requestParam)
                .eq("enable_status", 0)
                .groupBy("gid");
        List<Map<String, Object>> shortLinkD0List =baseMapper.selectMaps(queryWrapper);
        return BeanUtil.copyToList(shortLinkD0List, ShortLinkGroupCountQueryRespDTO.class);
    }
