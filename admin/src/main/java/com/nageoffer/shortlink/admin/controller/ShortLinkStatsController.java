...
public class ShortLinkStatsController {
    ...
    public Result<Page<ShortLinkStatsAccessRecordRespDTO>> shortLinkAccessRecordStats(ShortLinkStatsAccessRecordReqDTO requestParam) {
    ...
    public Result<Page<ShortLinkStatsAccessRecordRespDTO>> groupShortLinkAccessRecord(ShortLinkGroupStatsAccessRecordReqDTO requestParam) {
